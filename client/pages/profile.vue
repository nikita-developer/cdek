  ...
  <div class="profile">
    <div class="profile__head">
      ...
      <ul class="list-group list-group-flush profile__head-info">
        ...
        <li class="list-group-item profile__name">
          <span class="list-group-item__first-text" v-if="user.isActivated">Аккаунт подтвержен</span>
          <span class="list-group-item__first-text" v-else>Аккаунт не подтвержен</span>
        </li>
        <li class="list-group-item profile__name">
